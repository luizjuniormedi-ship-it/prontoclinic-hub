...
assert.match(script, /edge_rollback_smoke/);
assert.match(script, /"\$edge_helper" --smoke "\$edge_smoke_base"/);
assert.match(script, /"\$edge_helper" --smoke-rollback "\$edge_smoke_base"/);
assert.match(script, /ROLLBACK_SMOKE_OK/);
