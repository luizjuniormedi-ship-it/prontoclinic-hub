...
const RPC_PERMISSIONS = {
  ...
  m19_prepare_triage_handoff_secure: { module: 'recepcao', action: 'can_edit' },
  m19_complete_triage_secure: { module: 'enfermagem', action: 'can_create' },
  m19_reclassify_triage_secure: { module: 'enfermagem', action: 'can_edit' },
  m18_open_attendance_secure: { module: 'prontuario', action: 'can_create' },
  m18_save_attendance_secure: { module: 'prontuario', action: 'can_edit' },
  m18_finalize_attendance_secure: { module: 'prontuario', action: 'can_edit' },
  m18_complete_attendance_secure: { module: 'prontuario', action: 'can_edit' },
  ...
  m16_materialize_account_tiss_secure: { module: 'faturamento', action: 'can_edit' },
  m39_list_billing_accounts_secure: { module: 'faturamento', action: 'can_view' },
  m39_get_billing_account_secure: { module: 'faturamento', action: 'can_view' },
