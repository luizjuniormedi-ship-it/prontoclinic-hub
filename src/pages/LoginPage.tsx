        ...
        <CardContent>
          ...
          {!requires2FA ? (
            <form onSubmit={handleSubmit} className="space-y-4" aria-label="Formulário de login">
              ...
              <div className="relative my-2">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-wider">
                  <span className="bg-card px-2 text-foreground">ou</span>
                </div>
              </div>
            ...
            <form onSubmit={handle2FASubmit} className="space-y-4" aria-label="Verificação em duas etapas">
              ...
              <Button type="submit" className="w-full bg-foreground text-background hover:bg-foreground/90" disabled={loading || twoFactorCode.length < 6}>
                {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                Verificar
              </Button>
              <button
