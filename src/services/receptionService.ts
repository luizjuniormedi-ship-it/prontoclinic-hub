...
export interface ReceptionPrecheckinContext { appointment_id: number; patient_id: number | null; unit_id: number | null; ready: boolean; issues: CheckinIssue[]; has_document_pending: boolean; has_consent_pending: boolean; has_insurance_pending?: boolean; has_authorization_pending?: boolean; document_issues: CheckinIssue[]; consent_issues: CheckinIssue[]; insurance_issues?: CheckinIssue[]; authorization_issues?: CheckinIssue[]; insurance_card_number?: string | null; authorization_required?: boolean; authorization_number?: string | null; authorization_password?: string | null; authorization_valid_until?: string | null; authorization_procedure_id?: number | null; authorization_procedure_desc?: string | null }
