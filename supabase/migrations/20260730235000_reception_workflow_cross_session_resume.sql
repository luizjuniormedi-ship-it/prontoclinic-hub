-- Resume an interrupted Reception workflow after the browser session loses its
-- local idempotency key. The appointment remains the aggregate boundary and a
-- different payload is still rejected.
...
VALUES ('20260730235000_reception_workflow_cross_session_resume.sql')
